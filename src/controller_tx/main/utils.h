...
/**
 * @brief Calculate absolute value of an 8-bit integer.
 *
...
/**
 * @brief Calculate absolute value of a 16-bit integer.
 *
 * @param value Input value.
 *
 * @return Absolute value.
...
/**
 * @brief Calculate absolute value of a 32-bit integer.
 *
 * @param value Input value.
 *
 * @return Absolute value.
...
/**
 * @brief Clamp 8-bit integer value to specified range.
 *
...
/**
 * @brief Clamp 16-bit integer value to specified range.
 *
 * @param val Input value.
 * @param min Minimum allowed value.
 * @param max Maximum allowed value.
...
/**
 * @brief Clamp 32-bit integer value to specified range.
 *
 * @param val Input value.
 * @param min Minimum allowed value.
 * @param max Maximum allowed value.
